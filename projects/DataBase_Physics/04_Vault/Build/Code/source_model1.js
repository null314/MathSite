...
var Model1XObject = /** @class */ (function (_super) {
    __extends(Model1XObject, _super);
    function Model1XObject(pos, size) {
    ...
    Model1XObject.prototype.Init = function () {
        this.Position = new Vector2(10, 10);
        this.DPosition = new Vector2(20, 20);
    };
    Model1XObject.prototype.OnUpdate = function (dt) {
        //		правило производной		
        //		this.Position = this.Position + this.DPosition * dt;
        this.Position = this.Position.Plus(this.DPosition.Mult(dt));
    };
    Model1XObject.prototype.CheckForRestart = function () {
        return this.Position.X > 100;
    };
    Model1XObject.prototype.FinalPaintVirt = function () {
        this.DrawAxis();
