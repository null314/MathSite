...
var Ball = /** @class */ (function () {
    ...
    Ball.prototype.OnUpdate = function (dt) {
        //		вычислить ускорение
...
var Model5XObject = /** @class */ (function (_super) {
    __extends(Model5XObject, _super);
    function Model5XObject(pos, size) {
    ...
    Model5XObject.prototype.Init = function () {
    ...
    Model5XObject.prototype.OnUpdate = function (dt) {
        ...
        for (var _d = 0, _e = this.BallList; _d < _e.length; _d++) {
            var ball = _e[_d];
            ball.OnUpdate(dt);
        }
    };
    Model5XObject.prototype.CheckForRestart = function () {
        return false;
    };
    Model5XObject.prototype.GetCollideForce = function (ball1, ball2) {
    ...
    Model5XObject.prototype.FinalPaintVirt = function () {
        this.DrawAxis();
        for (var _i = 0, _a = this.BallList; _i < _a.length; _i++) {
            var ball = _a[_i];
