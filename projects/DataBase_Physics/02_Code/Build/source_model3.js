...
// 01_Code/Model3XObject.ts
var Model3XObject = /** @class */ (function (_super) {
    __extends(Model3XObject, _super);
    function Model3XObject(pos, size) {
    ...
    Model3XObject.prototype.Init = function () {
        this.Position = new Vector2(10, 10);
        this.DPosition = new Vector2(20, 40);
    };
    Model3XObject.prototype.OnUpdate = function (dt) {
    ...
    Model3XObject.prototype.CheckForRestart = function () {
        return this.Position.X > 100;
    };
    Model3XObject.prototype.FinalPaintVirt = function () {
        this.DrawAxis();
