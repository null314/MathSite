...
var scene = new MathSceneCanvas("canvasMultOne", colorScheme);
...
var a2 = scene.AddMathObject(new SingleMathObject(new Complex(1, 0), colorScheme.Arrow2Color, SingleMathObjectType.Simple, 2, new Vector2(300, 0), new Vector2(200, 200)));
